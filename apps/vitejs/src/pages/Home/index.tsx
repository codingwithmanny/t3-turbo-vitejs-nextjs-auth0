          ...
          <div className="w-full">
            <form onSubmit={onSubmitFormNewPost}>
              <div className="mb-4">
                ...
                <input
                  disabled={isDisabled || postCreate.isLoading}
                  required
...
const PostCard: React.FC<{
  ...
  // Render
  return (
    <div className="group card ring-4 ring-transparent transition-all duration-200  ease-in-out hover:border-transparent hover:ring-zinc-400">
